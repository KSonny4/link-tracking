...
/*
Package linktracking is a reverse proxy.
...
func request_Tracker_GetUrl_0(ctx context.Context, marshaler runtime.Marshaler, client TrackerClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq URLGenerateRequest
...
func local_request_Tracker_GetUrl_0(ctx context.Context, marshaler runtime.Marshaler, server TrackerServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq URLGenerateRequest
	var metadata runtime.ServerMetadata
...
func RegisterTrackerHandlerServer(ctx context.Context, mux *runtime.ServeMux, server TrackerServer) error {
	...
	mux.Handle("POST", pattern_Tracker_GetUrl_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/proto.Tracker/GetUrl", runtime.WithHTTPPathPattern("/api/v1/geturl"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Tracker_GetUrl_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_Tracker_GetUrl_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterTrackerHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TrackerClient) error {
	...
	mux.Handle("POST", pattern_Tracker_GetUrl_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/proto.Tracker/GetUrl", runtime.WithHTTPPathPattern("/api/v1/geturl"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Tracker_GetUrl_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Tracker_GetUrl_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "v1", "geturl"}, ""))
)

var (
	forward_Tracker_GetUrl_0 = runtime.ForwardResponseMessage
)
